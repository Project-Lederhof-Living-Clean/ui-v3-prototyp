...
export function AppShell({ children, navigationGroups, onNavigate }: AppShellProps) {
  ...
  const themeToggle = (
    <button
      ...
      className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-stone-700 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors"
    >
